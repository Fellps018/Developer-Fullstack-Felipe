...
<header class="header">
    ...
    <nav class="nav">
        <a href="#hero" class="nav-link"> <i class="fa-solid fa-house"></i> Home</a>
    ...
    <a href="https://wa.me/5515997238091" alt="Entrar em contato via Whatssapp." class="menu-toggle"> <i class="fa-brands fa-whatsapp"></i> Vamos Conversar</a>
    </div>
</header>
    )
}
